...
module LiveKit
  module Proto
    class SIPService < ::Twirp::Service
      ...
      rpc :UpdateSIPInboundTrunk, UpdateSIPInboundTrunkRequest, SIPInboundTrunkInfo, :ruby_method => :update_s_i_p_inbound_trunk
      rpc :UpdateSIPOutboundTrunk, UpdateSIPOutboundTrunkRequest, SIPOutboundTrunkInfo, :ruby_method => :update_s_i_p_outbound_trunk
      ...
      rpc :UpdateSIPDispatchRule, UpdateSIPDispatchRuleRequest, SIPDispatchRuleInfo, :ruby_method => :update_s_i_p_dispatch_rule
