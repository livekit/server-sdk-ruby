...
module LiveKit
  module Proto
    ...
    MetricsRecordingHeader = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("livekit.MetricsRecordingHeader").msgclass
