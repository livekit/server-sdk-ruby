...
module LiveKit
  module Proto
    class RoomServiceService < ::Twirp::Service
      ...
      rpc :MoveParticipant, MoveParticipantRequest, MoveParticipantResponse, :ruby_method => :move_participant
      rpc :PerformRpc, PerformRpcRequest, PerformRpcResponse, :ruby_method => :perform_rpc
    end
