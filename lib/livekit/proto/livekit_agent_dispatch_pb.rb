...
module LiveKit
  module Proto
    ...
    ListAgentDispatchRequesst = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("livekit.ListAgentDispatchRequesst").msgclass
