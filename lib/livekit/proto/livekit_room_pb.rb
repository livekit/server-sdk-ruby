...
module LiveKit
  module Proto
    ...
    ForwardParticipantRequest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("livekit.ForwardParticipantRequest").msgclass
    ForwardParticipantResponse = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("livekit.ForwardParticipantResponse").msgclass
  end
end
